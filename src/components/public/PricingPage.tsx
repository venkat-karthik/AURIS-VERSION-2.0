      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 space-y-4">
          ...
          <p className="text-base text-[#52636D]">
            All plans include natural human-like voice synthesis, calendar integrations, and our zero-latency telephony backbone. No hidden setup fees.
          </p>

          {/* Billing Cycle Toggle */}
          <div className="inline-flex items-center bg-white p-1 rounded-xl border border-[#DDEBEF] shadow-xs mt-4">
            <button
            ...
            return (
              <div
                ...
                className={`relative bg-white rounded-2xl p-6 border transition-all flex flex-col justify-between ${
                  isPopular
                    ? 'border-[#38A85B] shadow-lg ring-2 ring-[#38A85B]/20'
                    : 'border-[#DDEBEF] shadow-xs hover:shadow-md'
                }`}
              >
                {isPopular && (
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <h3 className="text-xl font-bold text-[#123047]">{plan.name}</h3>
                  </div>

                  <p className="text-xs text-[#52636D] min-h-[36px] mb-4">
                    {plan.description}
                  </p>

                  <div className="flex items-baseline gap-1 mb-6 pb-6 border-b border-[#DDEBEF]">
                    <span className="text-4xl font-extrabold text-[#123047]">${price}</span>
                    <span className="text-xs font-medium text-[#52636D]">/ month</span>
                  </div>

                  <div className="space-y-2 mb-6">
                    <div className="text-xs font-bold text-[#123047] uppercase tracking-wider mb-2">
                      Key Allocations:
                    </div>
                    <div className="text-xs text-[#123047] flex items-center justify-between py-1 bg-[#F5FAFC] px-2.5 rounded">
                      <span className="text-[#52636D]">Included Minutes</span>
                      <span className="font-bold text-[#2189C8]">{plan.minutesIncluded.toLocaleString()} min</span>
                    </div>
                    <div className="text-xs text-[#123047] flex items-center justify-between py-1 bg-[#F5FAFC] px-2.5 rounded">
                      <span className="text-[#52636D]">AI Voice Agents</span>
                      <span className="font-bold">{plan.agentsLimit} Agents</span>
                    </div>
                    <div className="text-xs text-[#123047] flex items-center justify-between py-1 bg-[#F5FAFC] px-2.5 rounded">
                      <span className="text-[#52636D]">Phone Numbers</span>
                  ...
                  <div className="space-y-2.5 mb-8">
                    ...
                    {plan.features.map((feature, idx) => (
                      <div key={idx} className="flex items-start gap-2 text-xs text-[#52636D]">
                ...
                <button
                  ...
                  className={`w-full py-3 rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center justify-center gap-1.5 ${
                    isPopular
                      ...
                      : 'bg-[#EEF8FC] hover:bg-[#DDEBEF] text-[#2189C8] border border-[#55B9E8]/30'
                  }`}
                >
                  Choose {plan.name}
        ...
        <div className="bg-white rounded-3xl p-8 border border-[#DDEBEF] shadow-xs mb-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-6 space-y-4">
              <div className="inline-flex items-center gap-1.5 text-xs font-bold text-[#2189C8] uppercase tracking-wider">
                <Calculator className="w-4 h-4" />
                Interactive Usage Calculator
              </div>
              <h2 className="text-2xl font-bold text-[#123047]">
              ...
              <div className="pt-4 space-y-2">
                <div className="flex justify-between items-center">
                  <span className="text-xs font-bold text-[#123047]">Estimated Monthly Minutes:</span>
                ...
                />
                <div className="flex justify-between text-[11px] text-[#82919A]">
            ...
            <div className="lg:col-span-6 p-6 rounded-2xl bg-[#F5FAFC] border border-[#DDEBEF] space-y-4">
              <div className="text-xs font-bold text-[#82919A] uppercase tracking-wider">
                Recommended Plan for Your Volume
              </div>
              <div className="flex items-baseline gap-2">
                <span className="text-2xl font-black text-[#123047] capitalize">
                  {recommended} Tier
                </span>
                <span className="text-xs text-[#38A85B] font-bold bg-[#EFFAF1] px-2 py-0.5 rounded-full">
                  Best Value Match
                </span>
              </div>
              ...
              <button
                ...
                className="w-full py-2.5 rounded-xl bg-[#123047] hover:bg-[#1a4261] text-white text-xs font-bold transition-all cursor-pointer flex items-center justify-center gap-2"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          <div className="bg-white p-6 rounded-2xl border border-[#DDEBEF]">
            <Shield className="w-8 h-8 text-[#38A85B] mx-auto mb-3" />
            <h4 className="font-bold text-sm text-[#123047] mb-1">HIPAA & SOC-2 Ready</h4>
            <p className="text-xs text-[#52636D]">End-to-end encrypted voice tunnels with zero persistent audio storage options.</p>
          </div>

          <div className="bg-white p-6 rounded-2xl border border-[#DDEBEF]">
            <Zap className="w-8 h-8 text-[#2189C8] mx-auto mb-3" />
            <h4 className="font-bold text-sm text-[#123047] mb-1">Sub-350ms Latency</h4>
            <p className="text-xs text-[#52636D]">Powered by OmniDimension ultra-low latency audio pipeline for authentic conversations.</p>
          </div>

          <div className="bg-white p-6 rounded-2xl border border-[#DDEBEF]">
            <HelpCircle className="w-8 h-8 text-[#38A85B] mx-auto mb-3" />
            <h4 className="font-bold text-sm text-[#123047] mb-1">24/7 Priority Support</h4>
            <p className="text-xs text-[#52636D]">Dedicated onboarding specialists and technical engineers to optimize your prompts.</p>
          </div>
        </div>
      </div>
    </div>
