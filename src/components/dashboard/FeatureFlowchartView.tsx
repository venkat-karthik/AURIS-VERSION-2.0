...
export const FeatureFlowchartView: React.FC<FeatureFlowchartViewProps> = ({
  ...
  const featureSpecs: Record<string, FeatureSpec> = {
    dashboard: {
      ...
      steps: [
        ...
        },
        {
          ...
          description: 'Dispatches webhook events to Google Calendar and writes audit record to Cloud Firestore.',
          tech: 'Google Workspace + Firestore',
          latency: '42ms',
    ...
    'agent-performance': {
      ...
      steps: [
        ...
        },
        {
          ...
          tech: 'Firestore Real-Time Stream',
          latency: '15ms',
    ...
    calls: {
      ...
      steps: [
        ...
        },
        {
          id: 'step-4',
          stepNumber: '04',
          title: 'Firestore & CRM Synchronization',
          nodeType: 'egress',
          description: 'Persists structured call log in Cloud Firestore and triggers connected integrations.',
          tech: 'Firestore + Webhooks',
          latency: '30ms',
    ...
    integrations: {
      ...
      subtitle: 'Native connectors for Google Calendar, Salesforce, HubSpot, Razorpay, and Cloudinary',
      ...
      steps: [
        ...
        },
        {
          ...
          nodeType: 'egress',
          description: 'Logs delivery receipt in Firestore with automatic exponential backoff if third-party is slow.',
          tech: 'Cloud Firestore Event Audit',
          latency: '15ms',
    ...
    billing: {
      ...
      steps: [
        ...
        },
        {
          ...
          tech: 'Firestore Atomic Increment',
          latency: '18ms',
