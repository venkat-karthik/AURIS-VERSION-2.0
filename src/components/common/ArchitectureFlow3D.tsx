...
const STAGES: StageNode[] = [
  ...
  },
  {
    ...
    subtitle: 'Cloudinary, Google Forms & CRM',
    latency: 'Immediate',
    icon: FileSpreadsheet,
    badge: 'Auto Sync',
    description: 'Call recording streams to Cloudinary, extracted appointment details sync to Google Forms/Calendar, and billing updates via Razorpay.',
    techDetails: {
      protocol: 'Webhooks & Cloudinary API',
